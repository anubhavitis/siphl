    ...
    <Card>
      <CardContent className="p-4 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <DetailRow
            label="Price"
            value={currentPrice !== null ? formatUsd(currentPrice, 6) : "--"}
          />
          <DetailRow
            label="Balance"
            value={
          ...
          <DetailRow
            label="Invested"
            value={
              entryNtl !== null && entryNtl > 0 ? formatUsd(entryNtl) : "--"
            }
          />
          <DetailRow
            label="Avg Buy"
            value={avgBuyPrice !== null ? formatUsd(avgBuyPrice, 6) : "--"}
          />
        </div>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Are you sure you want to cancel this SIP for {coin}? This
